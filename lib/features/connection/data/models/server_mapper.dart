...
abstract final class ServerMapper {
  static ServerEntity fromDrift(Server row, {List<TagEntity> tags = const []}) {
    return ServerEntity(
      ...
      osDetectedAt: row.osDetectedAt,
      systemMetricsJson: row.systemMetricsJson,
  ...
  static ServersCompanion toCompanion(ServerEntity entity) {
    return ServersCompanion(
      ...
      osFamily: Value(entity.osFamily),
      osName: Value(entity.osName),
      osVersion: Value(entity.osVersion),
      osPrettyName: Value(entity.osPrettyName),
      osDetectedAt: Value(entity.osDetectedAt),
      systemMetricsJson: Value(entity.systemMetricsJson),
