...
int get hashCode {
  final _this = this as ProxyConfig;
  return Object.hash(runtimeType,_this.type,_this.host,_this.port,_this.username);
}

@override
String toString() {
  final _this = this as ProxyConfig;
  return 'ProxyConfig(type: ${_this.type}, host: ${_this.host}, port: ${_this.port}, username: ${_this.username})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,type,host,port,username);
}
