...
int get hashCode {
  final _this = this as ServerCredentials;
  return Object.hash(runtimeType,_this.password,_this.privateKey,_this.publicKey,_this.passphrase);
}

@override
String toString() {
  final _this = this as ServerCredentials;
  return 'ServerCredentials(password: ${_this.password}, privateKey: ${_this.privateKey}, publicKey: ${_this.publicKey}, passphrase: ${_this.passphrase})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? password = freezed,Object? privateKey = freezed,Object? publicKey = freezed,Object? passphrase = freezed,}) {
  return _then(ServerCredentials(
...
@override
int get hashCode {
    return Object.hash(runtimeType,password,privateKey,publicKey,passphrase);
}
