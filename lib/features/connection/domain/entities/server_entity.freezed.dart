...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,hostname,port,username,authMethod,notes,color,iconName,isActive,groupId,sshKeyId,sortOrder,distroId,distroName,const DeepCollectionEquality().hash(tags),ownerId,sharedWith,permissions,createdAt,updatedAt]);

@override
String toString() {
  return 'ServerEntity(id: $id, name: $name, hostname: $hostname, port: $port, username: $username, authMethod: $authMethod, notes: $notes, color: $color, iconName: $iconName, isActive: $isActive, groupId: $groupId, sshKeyId: $sshKeyId, sortOrder: $sortOrder, distroId: $distroId, distroName: $distroName, tags: $tags, ownerId: $ownerId, sharedWith: $sharedWith, permissions: $permissions, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
switch (_that) {
case _ServerEntity() when $default != null:
return $default(_that.id,_that.name,_that.hostname,_that.port,_that.username,_that.authMethod,_that.notes,_that.color,_that.iconName,_that.isActive,_that.groupId,_that.sshKeyId,_that.sortOrder,_that.distroId,_that.distroName,_that.tags,_that.ownerId,_that.sharedWith,_that.permissions,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,hostname,port,username,authMethod,notes,color,iconName,isActive,groupId,sshKeyId,sortOrder,distroId,distroName,const DeepCollectionEquality().hash(_tags),ownerId,sharedWith,permissions,createdAt,updatedAt]);
