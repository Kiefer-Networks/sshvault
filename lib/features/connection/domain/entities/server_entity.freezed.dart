...
mixin _$ServerEntity {
 ...
 String get id; String get name; String get hostname; int get port; String get username; AuthMethod get authMethod; String get notes; int get color; String get iconName; bool get isActive; String? get groupId; String? get sshKeyId; int get sortOrder; List<TagEntity> get tags; String? get ownerId; String? get sharedWith; String? get permissions; DateTime get createdAt; DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,hostname,port,username,authMethod,notes,color,iconName,isActive,groupId,sshKeyId,sortOrder,const DeepCollectionEquality().hash(tags),ownerId,sharedWith,permissions,createdAt,updatedAt]);

@override
String toString() {
  return 'ServerEntity(id: $id, name: $name, hostname: $hostname, port: $port, username: $username, authMethod: $authMethod, notes: $notes, color: $color, iconName: $iconName, isActive: $isActive, groupId: $groupId, sshKeyId: $sshKeyId, sortOrder: $sortOrder, tags: $tags, ownerId: $ownerId, sharedWith: $sharedWith, permissions: $permissions, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String name, String hostname, int port, String username, AuthMethod authMethod, String notes, int color, String iconName, bool isActive, String? groupId, String? sshKeyId, int sortOrder, List<TagEntity> tags, String? ownerId, String? sharedWith, String? permissions, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of ServerEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? hostname = null,Object? port = null,Object? username = null,Object? authMethod = null,Object? notes = null,Object? color = null,Object? iconName = null,Object? isActive = null,Object? groupId = freezed,Object? sshKeyId = freezed,Object? sortOrder = null,Object? tags = null,Object? ownerId = freezed,Object? sharedWith = freezed,Object? permissions = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
as List<TagEntity>,ownerId: freezed == ownerId ? _self.ownerId : ownerId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String hostname,  int port,  String username,  AuthMethod authMethod,  String notes,  int color,  String iconName,  bool isActive,  String? groupId,  String? sshKeyId,  int sortOrder,  List<TagEntity> tags,  String? ownerId,  String? sharedWith,  String? permissions,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServerEntity() when $default != null:
return $default(_that.id,_that.name,_that.hostname,_that.port,_that.username,_that.authMethod,_that.notes,_that.color,_that.iconName,_that.isActive,_that.groupId,_that.sshKeyId,_that.sortOrder,_that.tags,_that.ownerId,_that.sharedWith,_that.permissions,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _ServerEntity implements ServerEntity {
  const _ServerEntity({required this.id, required this.name, required this.hostname, required this.port, required this.username, required this.authMethod, this.notes = '', required this.color, this.iconName = 'server', this.isActive = true, this.groupId, this.sshKeyId, this.sortOrder = 0, final  List<TagEntity> tags = const [], this.ownerId, this.sharedWith, this.permissions, required this.createdAt, required this.updatedAt}): _tags = tags;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,hostname,port,username,authMethod,notes,color,iconName,isActive,groupId,sshKeyId,sortOrder,const DeepCollectionEquality().hash(_tags),ownerId,sharedWith,permissions,createdAt,updatedAt]);
...
/// Create a copy of ServerEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? hostname = null,Object? port = null,Object? username = null,Object? authMethod = null,Object? notes = null,Object? color = null,Object? iconName = null,Object? isActive = null,Object? groupId = freezed,Object? sshKeyId = freezed,Object? sortOrder = null,Object? tags = null,Object? ownerId = freezed,Object? sharedWith = freezed,Object? permissions = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
