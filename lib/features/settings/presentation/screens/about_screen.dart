...
class AboutScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListView(
      ...
      children: [
        SettingsPaneHeader(title: l10n.settingsSectionAbout),
        Spacing.verticalXxl,
        ...
        // Crash dumps â€” Windows only in practice. The provider returns a
        ...
        if (Platform.isWindows) ...[
          ...
          // One-line privacy note â€” explicit so users know dumps stay
        ...
        // iPadOS keyboard shortcuts info â€” shown only when running on
          ...
          const SettingsGroupCard(
            children: [
              SettingsTile(
                ...
                subtitleText:
                    'Cmd-N new host  Â·  Cmd-W close tab  Â·  Cmd-T new tab  Â·  '
                    'Cmd-, settings  Â·  Cmd-F search  Â·  Ctrl-Tab switch tab',
              ),
            ],
          ),
          Spacing.verticalLg,
